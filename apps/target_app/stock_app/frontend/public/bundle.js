...
(() => {
  ...
  var ApiError, API_URL, apiClient, authToken;
  var init_api = __esm({
    "src/services/api.ts"() {
      "use strict";
      init_axios2();
      ...
      API_URL = "http://13.212.197.248:8080/";
      ...
      apiClient.interceptors.response.use(
        ...
        (error) => {
          ...
          const fallback = status === 0 ? "\u0E44\u0E21\u0E48\u0E2A\u0E32\u0E21\u0E32\u0E23\u0E16\u0E40\u0E0A\u0E37\u0E48\u0E2D\u0E21\u0E15\u0E48\u0E2D\u0E01\u0E31\u0E1A Backend \u0E44\u0E14\u0E49" : error.code === "ERR_NETWORK" ? "\u0E40\u0E04\u0E23\u0E37\u0E2D\u0E02\u0E48\u0E32\u0E22\u0E21\u0E35\u0E1B\u0E31\u0E0D\u0E2B\u0E32 \u0E01\u0E23\u0E38\u0E13\u0E32\u0E25\u0E2D\u0E07\u0E43\u0E2B\u0E21\u0E48" : "\u0E40\u0E01\u0E34\u0E14\u0E02\u0E49\u0E2D\u0E1C\u0E34\u0E14\u0E1E\u0E25\u0E32\u0E14\u0E08\u0E32\u0E01\u0E40\u0E0B\u0E34\u0E23\u0E4C\u0E1F\u0E40\u0E27\u0E2D\u0E23\u0E4C";
  ...
  var init_auth_service = __esm({
    "src/services/auth.service.ts"() {
      ...
      authService = {
        async register(dto) {
          const response = await apiClient.post("/api/v1/auth/register", dto);
          return response.data;
        },
        async login(dto) {
          const response = await apiClient.post("/api/v1/auth/login", dto);
  ...
  var stockService;
  var init_stock_service = __esm({
    "src/services/stock.service.ts"() {
      "use strict";
      init_api();
      stockService = {
        async listProducts() {
          const response = await apiClient.get("/api/v1/stock/products");
          return response.data;
        },
        async getProduct(id) {
          const response = await apiClient.get(`/api/v1/stock/products/${id}`);
          return response.data;
        },
        async createProduct(dto) {
          const response = await apiClient.post("/api/v1/stock/products", dto);
          return response.data;
        },
        ...
        setInventory: async (id, quantity) => {
          return await fetchAPI(`/api/v1/stock/products/${id}/inventory`, {
            method: "PATCH",
            body: JSON.stringify({ quantity })
            // ส่ง quantity เป็นตัวเลขตรงๆ ไปเลย
          });
        }
      };
    }
    ...
    "src/services/order.service.ts"() {
      ...
      orderService = {
        async placeOrder(dto) {
          const response = await apiClient.post("/api/v1/orders", dto);
          return response.data;
        },
        async listOrders() {
